...
public enum CommentResponseCode implements ResponseCode {
    ...
    OK_UPDATE_COMMENT(HttpStatus.NO_CONTENT.value(), "SUCCESS TO UPDATE COMMENT"),
    OK_DELETE_COMMENT(HttpStatus.NO_CONTENT.value(), "SUCCESS TO DELETE COMMENT"),
    OK_DELETE_LIKE(HttpStatus.NO_CONTENT.value(), "SUCCESS TO DELETE LIKE");
