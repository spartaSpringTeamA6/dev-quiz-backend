...
public enum TeamResponseCode implements ResponseCode {
    ...
    NO_CONTENT_WITHDRAW_TEAM(HttpStatus.NO_CONTENT, "SUCCESS TO EXPEL TEAM MEMBER"),
    NO_CONTENT_DELETE_TEAM(HttpStatus.NO_CONTENT, "SUCCESS TO DELETE TEAM"),
    NO_CONTENT_INVITE_TEAM_USER(HttpStatus.NO_CONTENT, "SUCCESS TO INVITE TEAM USER");
